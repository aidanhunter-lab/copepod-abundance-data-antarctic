plotMap <- function(map_data,
                    ...
                    base_layer = NULL, base_factor = NULL, base_aes = NULL, base_colour = NULL,
                    base_fill = NULL, base_linewidth = NULL,
  ...
  if(is.null(map_colour)) map_colour <- c(land = 'lightgrey', ice = 'skyblue', ocean = 'white', coastline = 'black', boundary = 'black')
...
# Land masses -------------------------------------------------------------
  ...
  # plt <- plt + 
  #   theme(plot.background = element_rect(fill = map_colour['ocean']))
  # 
  # theme(panel.background = element_rect(fill = background.colour),
